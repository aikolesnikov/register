...
CREATE TABLE `agent_property` (
  ...
  `value_text` text,
  PRIMARY KEY (`id`),
  KEY `fk_agent_property_1_idx` (`agent_id`),
  CONSTRAINT `fk_agent_property_1` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`id`) ON UPDATE CASCADE
...
LOCK TABLES `agent_property` WRITE;
/*!40000 ALTER TABLE `agent_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `agent_property` ENABLE KEYS */;
UNLOCK TABLES;
